                        ...
                        <div class="card-body">
                            ...
                            <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" class="form-control name taskname" name="taskname" required autofocus
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="description" type="description" class="form-control email description" name="description"
                                     required value='<?php echo $task[0]->description; ?>'>
                                    <div class="invalid-feedback">
